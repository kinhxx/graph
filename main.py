...
INPUT_DIR = r"D:\Code\Microsoft VS Code\project\graphrag-new\GraphragTest-main\ragtest\inputs\artifacts"
...
async def setup_llm_and_embedder():
    ...
    llm = ChatOpenAI(
        ...
        # 调用其他模型  通过oneAPI
        api_base="https://api.deepseek.com/v1",  # 请求的API服务地址
        api_key="sk-b6811861c0284af995399b68b794b1a8",  # API Key
